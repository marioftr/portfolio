...
export const aboutByRole = {
    ...
    video_editor: {
        ...
        ca: "Estudiant de Màster en Disseny, Modelatge i Programació de Videojocs al CEI de Madrid i graduat en Comunicació Audiovisual per la Universitat de Santiago de Compostela (USC) amb menció en Ideació i Creació de Continguts Audiovisuals.\n\nEditor de vídeo especialitzat en muntatge, correcció de color i motion graphics. Domino Adobe Premiere Pro i After Effects, i treballo con DaVinci Resolve para etalonatge profesional. Tinc experiència en pipelines de postproducció i adaptació de material per a diferents plataformes.",
