...
export const aboutByRole = {
    artist_2d_3d: {
        ...
        ca: "Estudio un Màster en Disseny, Modelatge i Programació de Videojocs al CEI de Madrid. Durant el meu Grau en Comunicació Audiovisual vaig cursar l'assignatura d'Animació 3D, que va complementar la meva formació tècnica en eines de modelatge i animació.\n\nArtista 2D i 3D amb experiència en modelatge, escultura i animació. Treballo amb Autodesk Maya, ZBrush i Blender, i aplico fluxos PBR a Substance Painter per al texturitzat. He participat en projectes acadèmics i comercials on produeixo des d'assets fins a animacions finals.",
    ...
    video_editor: {
        ...
        ca: "Estudio un Màster en Disseny, Modelatge i Programació de Videojocs. Durant el meu Grau en Comunicació Audiovisual amb menció en Ideació i Creació de Continguts Digitals, vaig adquirir una formació sòlida en edició de vídeo professional, que és la base del meu treball actual.\n\nEditor de vídeo especialitzat en muntatge, correcció de color i motion graphics. Domino Adobe Premiere Pro i After Effects, i treballo amb DaVinci Resolve per a etalonatge professional. Tinc experiència en pipelines de postproducció i adaptació de material per a diferents plataformes.",
...
export const education = [
    ...
    },
    {
        ...
        description: {
            ...
            en: 'Mention in Digital Content Ideation and Creation. Fundamental training in professional video editing (Adobe Premiere Pro), 3D animation and modeling (Adobe After Effects, Blender), and virtual reality integration (Brainstorm Edison). Courses in Video Game Creation and 3D Animation complement my technical skills. Used high-quality audiovisual material in numerous projects and participated in amateur and professional shoots.',
            gl: 'Mención en Ideación e Creación de Contidos Dixitais. Formación fundamental en edición de vídeo profesional (Adobe Premiere Pro), animación e modelado 3D (Adobe After Effects, Blender) e integración de realidade virtual (Brainstorm Edison). Destacan as materias de Creación de Videoxogos e Animación 3D que complementan as miñas habilidades técnicas. Uso en numerosos proxectos de material audiovisual de alta calidade e participación en rodaxes de nivel amateur e profesional.'
        },
